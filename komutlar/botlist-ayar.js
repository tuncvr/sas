...
exports.run = function(client, message, args) {
  ...
  if (!message.member.hasPermission("ADMINISTRATOR")) return message.channel.send(`:no_entry: Bu komutu kullanabilmek için "\`Yönetici\`" yetkisine sahip olmalısın.`);
	if(!args[0]) return message.channel.send(new Discord.MessageEmbed()
                                          ...
                                          .setDescription(`
                                          > <:cat1:814445458679398432> **• \`-botlist-ayar botekle-kanal #kanal\` => Bot Ekleme Kanalını Ayarlarsınız.**

                                          > <:cat1:814445458679398432>  **• \`-botlist-ayar botlog-kanal #kanal\` Bot Log Kanalını Ayarlarsınız.**
                                          
                                          > <:cat1:814445458679398432> **• \`-botlist-ayar başvurugiden-kanal #kanal\` Başvuru Logunu Ayarlarsınız.**
                                          
                                          > <:cat1:814445458679398432>  **• \`-botlist-ayar yetkili @rol\` Botlist Yetkili Rolünü Ayarlarsınız.**
                                          
                                           \`\`\` ayarlamalıdır herkez kullanabilir\`\`\``)
