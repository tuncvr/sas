...
exports.run = async (client, msg, args) => {
    ...
    if (result === 'won') {
        answer = '<a:tik1:819480965037948928> Başarılı, sen **Kazandın** <a:tik1:819480965037948928> \nSenin Seçtiği: `' + choice + '` | Bot\'un Seçtiği: `' + botChoice + '`';
    } else if (result === 'lost') {
        answer = '<a:no1:819480968338341969> Bidakine **Kaybetin Dostum** <a:no1:819480968338341969> \nSenin Seçtiğin: `' + choice + '` | Bot\'un Seçtiği: `' + botChoice + '`';
    } else if (result === 'draw') {
        answer = '<:neee:819481054892916767> Sonuç **Berabere** :<:neee:819481054892916767>\nSenin Seçimin: `' + choice + '` | Bot\'un Seçimi: `' + botChoice + '`';
    }
